                    ...
                    <div class="col-lg-5">
                        <div class="pt-xl-5 pt-lg-0 pt-md-5 pb-lg-5 px-lg-5">
                            ...
                            <div class="mb-4 pt-md-3">
                                <h6>Email</h6>
                                <p class="lh-lg"><a href="mailto:<?= EMAIL_1 ?>" class="text-secondary"><?= EMAIL_1 ?></a></p>
                            </div>
                            <div class="mb-4 pt-md-3">
                                <h6 class="mb-3">Phone</h6>
                                <p class="mb-2"><a href="tel:<?= CONTACT_1 ?>" class="text-secondary"><?= CONTACT_1 ?></a></p>
                                <p><a href="tel:<?= CONTACT_2 ?>" class="text-secondary"><?= CONTACT_2 ?></a></p>
                            </div>
                        </div>
                    </div>
                </div>
