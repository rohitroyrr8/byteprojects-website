                ...
                <div class="swiper-slider-box">
                    <div class="swiper-container swiper-clients swiper-container-initialized swiper-container-horizontal aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                        <div class="swiper-wrapper" style="transform: translate3d(35.9113px, 0px, 0px); transition: all 0ms ease 0s;">
                            <div class="swiper-slide h-100 swiper-slide-prev" style=" margin-right: 20px; width: 252px !important">
                            ...
                            <div class="swiper-slide h-100 swiper-slide-active" style=" margin-right: 20px; width: 252px !important">
                                <figure class="card muse-card rounded-12 h-100">
                                    <a href="#" class="muse-animation">
                            ...
                            <div class="swiper-slide h-100 swiper-slide-next" style=" margin-right: 20px; width: 252px !important">
                                <figure class="card muse-card rounded-12 h-100">
                                    <a href="#" class="muse-animation">
                            ...
                            <div class="swiper-slide" style=" margin-right: 20px; width: 252px !important">
                        ...
                        <div class="row">
                            <div class="col-md-3 text-center">
                                <div class="m-3 p-3" style="height: 85px">
                                    <img style="width: 125px" src="https://cdn.pixabay.com/photo/2015/04/23/17/41/node-js-736399_960_720.png" alt="">
                                </div>
                            </div>
                            <div class="col-md-3 text-center">
                                <div class="m-3 p-3" style="height: 85px">
                                    <img style="width: 125px" src="https://www.seekpng.com/png/full/399-3990193_building-a-go-web`-app-from-scratch-to.png" alt="">
                                </div>
                            </div>
                            <div class="col-md-3 text-center">
                                <div class="m-3 p-3" style="height: 85px">
                            ...
                            <div class="col-md-3 text-center">
                                <div class="m-3 p-3" style="height: 85px">
                                    <img style="width: 125px" src="https://www.metaltoad.com/sites/default/files/styles/large_personal_photo_870x500_/public/2020-05/react-js-blog-header.png?itok=VbfDeSgJ" alt="">
                                </div>
                            </div>
                            <div class="col-md-3 text-center">
                                <div class="m-3 p-3" style="height: 85px">
                            ...
                            <div class="col-md-3 text-center">
                                <div class="m-3 p-3" style="height: 85px">
                                    <img style="width: 125px" src="https://www.docker.com/sites/default/files/d8/2019-07/horizontal-logo-monochromatic-white.png" alt="">
                                </div>
                            </div>
                            <div class="col-md-3 text-center">
                                <div class="m-3 p-3" style="height: 85px">
                                    <img style="width: 125px" src="https://kubernetes.io/images/kubernetes-horizontal-color.png" alt="">
                                </div>
                            </div>
                            <div class="col-md-3 text-center">
                                <div class="m-3 p-3" style="height: 85px">
                                    <img style="width: 125px" src="https://logos-download.com/wp-content/uploads/2016/12/Amazon_Web_Services_logo_AWS.png" alt="">
                                </div>
                            </div>
                            <div class="col-md-3 text-center">
                                <div class="m-3 p-3" style="height: 85px">
                            ...
                            <div class="col-md-3 text-center">
                                <div class="m-3 p-3" style="height: 85px">
                                    <img style="width: 125px" src="https://webassets.mongodb.com/_com_assets/cms/MongoDB_Logo_FullColorBlack_RGB-4td3yuxzjs.png" alt="">
                                </div>
                            </div>
                            <div class="col-md-3 text-center">
                                <div class="m-3 p-3" style="height: 85px">
