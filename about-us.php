                    ...
                    <div class="col-lg-12">
                        <div class="my-3">
                            ...
                            <div class="my-4 pb-2 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                                <img src="../../assets/img/pages/about-us.jpg" class="rounded-12 w-100" alt="img" />
                            </div>
                            ...
                            <p class="big mb-0 lh-lg text-black-600 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
            ...
            <section class="muse-section">
                <div class="bg-blue-400 rounded-12 py-5 px-4 text-center position-relative aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="position-bottom">
                        <img src="../../assets/img/templates/shape5.png" alt="img" />
                    </div>
                </div>
            </section>
        </div>
