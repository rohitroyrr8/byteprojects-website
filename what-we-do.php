...
<html lang="en">
    <head>
        ...
        <title>What We Do | Blockchain Technology Development Company | <?= APP_NAME ?></title>
    ...
    <body class="saas3-template bg-gray-100" data-aos-easing="ease-out" data-aos-duration="400" data-aos-delay="0">
        <div class="container">
                            ...
                            <div class="mt-5 row">
                                <div class="col-md-6">
                                    <div class="my-4 pb-2 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                                        <img src="https://www.block8.com/hubfs/Block8_April_2020/Images/product-discovery-validation.svg" class="rounded-12 w-100" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h1 class="display-4">Product Discovery & Validation</h1>
            ...
            <section class="muse-section">
                <div class="col-md-6">
                    <div class="my-4 pb-2 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                        <img src="https://www.block8.com/hubfs/Block8_April_2020/Images/mvp-development.svg" class="rounded-12 w-100" alt="">
                    </div>
                </div>
                <div class="col-md-6">
                    <h1 class="display-4">MVP Development</h1>
                    <p class="aos-animate aos-init" data-aos="fade-up" data-aos-delay="100" style=" margin-top: 127px; ">
            ...
            <section class="muse-section">
                <div class="col-md-6">
                    <div class="my-4 pb-2 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                        <img src="https://www.block8.com/hubfs/Block8_April_2020/Images/support-transition.svg" class="rounded-12 w-100" alt="">
                    </div>
                </div>
                <div class="col-md-6">
                    <h1 class="display-4">Support & Transition</h1>
                    <p class="aos-animate aos-init" data-aos="fade-up" data-aos-delay="100" style=" margin-top: 127px; ">
            ...
            <section class="muse-section">
                <div class="col-md-6">
                    <div class="my-4 pb-2 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                        <img src="https://www.block8.com/hubfs/Block8_April_2020/Images/traction-raise.svg" class="rounded-12 w-100" alt="">
                    </div>
                </div>
                <div class="col-md-6">
                    <h1 class="display-4">Traction & Raise</h1>
                    <p class="aos-animate aos-init" data-aos="fade-up" data-aos-delay="100" style=" margin-top: 127px; ">
